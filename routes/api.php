...
Route::group([
    ...
    function () {
        ...
        Route::get('/me/organizations', 'UserController@getMyOrganizations');

        Route::get('/me/organizations/users', 'OrganizationController@getUsersInMyOrganization');
...
//        //ORGANIZATION
////                Route::get('organizationsorganizations', 'OrganizationController@index');
...
////                Route::delete('/{organizationsorganization}', 'OrganizationController@destroy');
//        Route::put('organizations/current/update', 'OrganizationController@updatePrimaryOrganization');
//        Route::post('organizations/{id}/upload_logo', 'OrganizationController@uploadLogo');
//        Route::delete('organizations/{id}/remove_logo', 'OrganizationController@removeLogo');
//
//        Route::get('organizations/{id}/contacts', 'OrganizationContactController@index');
//        Route::get('organizations/{id}/contacts/{id}', 'OrganizationContactController@show');
//        Route::post('organizations/{id}/contacts', 'OrganizationContactController@store');
//        Route::put('organizations/{id}/contacts/{id}', 'OrganizationContactController@update');
//        Route::delete('organizations/{id}/contacts/{id}', 'OrganizationContactController@destroy');
//        Route::get('organizations/{id}/contacts/set_primary/{id}', 'OrganizationContactController@setPrimary');
//        Route::get('organizations/{id}/contacts/resend_verification/{id}', 'OrganizationContactController@resendVerification');
